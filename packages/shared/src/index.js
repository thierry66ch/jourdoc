...
export const API_ROUTES = {
  ...
  JD_MEDIA_ASSET:   (wsId, id) => `/api/jourdoc/${wsId}/medias/${id}/asset`,
  JD_EXTDOCS_CREATE:(wsId) => `/api/jourdoc/${wsId}/extdocs/create`,
  ...
  JD_EXTDOCS_FILE:  (wsId) => `/api/jourdoc/${wsId}/extdocs/file`,
  ...
  JD_SCHEMAS:        (wsId) => `/api/jourdoc/${wsId}/schemas-donnees`,
  JD_SCHEMA:         (wsId, id) => `/api/jourdoc/${wsId}/schemas-donnees/${id}`,
  JD_SCHEMA_RESOLVE: (wsId) => `/api/jourdoc/${wsId}/schemas-donnees/resolve`,
